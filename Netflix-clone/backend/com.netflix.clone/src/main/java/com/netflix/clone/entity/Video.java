...
public class Video {
    ...
    public String getSrc() {
        if(srcUuid != null && !srcUuid.isEmpty()) {
            String badeUrl = ServletUriComponentsBuilder.fromCurrentContextPath().toUriString();
            return badeUrl+ "/api/files/video/"+srcUuid;
        }
        return null;
    }
    ...
    public String getPoster() {
        if(posterUuid != null && !posterUuid.isEmpty()) {
            String badeUrl = ServletUriComponentsBuilder.fromCurrentContextPath().toUriString();
            return badeUrl+ "/api/files/poster/"+posterUuid;
        }
        return null;
    }

...
public class VideoServiceImpl implements VideoService {
    ...
    public MessageResponse createVideoByAdmin(VideoRequest videoRequest) {
        ...
        System.out.println("createVideoByAdmin: "+video.getDescription()+" "+ video.getYear()+" "+ video.getRating()+" "+ video.getCategories());

        videoRepository.save(video);
        return new MessageResponse("Video create successfully.");
    }
    ...
    public MessageResponse deleteVideoByAdmin(Long id) {
        ...
        return new MessageResponse("Video delete successfully.");
    }
    ...
    public VideoStatsResponse getAdminStats() {
        ...
        long publishedVideo = videoRepository.countPublishedVideo();
        long totalDuration = videoRepository.getTotalDuration();

        return new VideoStatsResponse(totalVideo, publishedVideo, totalDuration);
    }
